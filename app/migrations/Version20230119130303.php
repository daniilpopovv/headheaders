 ...
 */
final class Version20230119130303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recruiter (id INT NOT NULL, company_id INT DEFAULT NULL, username VARCHAR NOT NULL, roles JSON NOT NULL, password VARCHAR NOT NULL, full_name VARCHAR NOT NULL, email VARCHAR NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE resume (id INT NOT NULL, seeker_id INT NOT NULL, specialization VARCHAR NOT NULL, description VARCHAR DEFAULT NULL, salary INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE seeker (id INT NOT NULL, username VARCHAR NOT NULL, roles JSON NOT NULL, password VARCHAR NOT NULL, full_name VARCHAR NOT NULL, email VARCHAR NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE vacancy (id INT NOT NULL, recruiter_id INT NOT NULL, specialization VARCHAR NOT NULL, description VARCHAR DEFAULT NULL, salary INT NOT NULL, PRIMARY KEY(id))');
